  ...
  <!-- 
	...
	<header role="banner" id="fh5co-header">
			<div class="container">
		        ...
		        <div class="navbar-header">
		         ...
		         <a class="navbar-brand" href="index.html">Location Logger</a> 
		        </div>
			...
			<div class="row row-bottom-padded-lg">
				<div class="fh5co-block to-animate" style="background-image: url(images/img_7.jpg);">
					...
					<div class="fh5co-text">
						...
						<h2>Plan</h2>
						<p>Start planning now it's a huge journy that we are about to cross. We'll make sure the day turns out to be great</p>
						<p><a href="#" class="btn btn-primary">Learn how</a></p>
					</div>
				</div>
				<div class="fh5co-block to-animate" style="background-image: url(images/img_8.jpg);">
					...
					<div class="fh5co-text">
						...
						<h2>Hire</h2>
						<p>Hire the places you desire in a few clicks with ous. We make sure the price is reasonable and we also ensure your comfort.</p>
				...
				<div class="fh5co-block to-animate" style="background-image: url(images/img_10.jpg);">
					...
					<div class="fh5co-text">
						...
						<h2>Play</h2>
						<p>Enjoy your with what you signed up for. We'll give you the full credit of accessing the full list of enquires with us.</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Current Clients</h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>The number of clients that we receive request from is growing exponentially. Here are some of the top ones.</h3>
						</div>
					</div>
				</div>
			</div>
	...
	<section id="fh5co-testimonials" data-section="testimonials">
		<div class="container">
			<div class="row">
				<div class="col-md-12 section-heading text-center">
					<h2 class="to-animate">Hear out for feedback</h2>
					<div class="row">
						<div class="col-md-8 col-md-offset-2 subtext to-animate">
							<h3>Thanks for all the Customers for the unmatched support and love..</h3>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col-md-4">
					<div class="box-testimony">
						<blockquote class="to-animate-2">
							<p>&ldquo;WOW!! very good reservation scheme.. Totally enjoyed the day..&rdquo;</p>
						</blockquote>
						<div class="author to-animate">
							<figure><img src="images/person1.jpg" alt="Person"></figure>
							<p>
							Arvind Srinivasan<span class="subtext">Daimler</span>
							</p>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="box-testimony">
						...
						<div class="author to-animate">
							...
							<p>
							Leon<span class="subtext">Daimler</span>
							</p>
						</div>
					</div>
				</div>
				...
				<div class="col-md-4">
					<div class="box-testimony">
						...
						<div class="author to-animate">
							...
							<p>
							Summan <!--<a href="http://freehtml5.co/" target="_blank">FREEHTML5.co</a>--> <span class="subtext">Daimler</span>
							</p>
						</div>
					</div>
				</div>
		...
		<div class="container">
				...
				<div class="col-md-12 section-heading text-left">
					...
					<div class="row">
						<div class="col-md-8 subtext to-animate">
							<h3>We deliver Services that can blow your minds.. 😜 Just saying.. </h3>
						</div>
					</div>
				</div>
			</div>
			<div class="row">
				...
				<div class="col-md-6 col-sm-6 fh5co-service to-animate">
					...
					<h3>Photo &amp; Video of the property</h3>
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean</p>
				</div>
				<div class="col-md-6 col-sm-6 fh5co-service to-animate">
					<i class="icon to-animate-2 icon-monitor"></i>
					<h3>Real time Updation</h3>
					<p>Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts. Separated they live in Bookmarksgrove right at the coast of the Semantics, a large language ocean</p>
				</div>
			...
			<div class="row">
				<div class="col-md-4">
					<div class="fh5co-person text-center to-animate">
						...
						<span class="fh5co-position">Daimler</span>
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="fh5co-counter to-animate">
						...
						<span class="fh5co-counter-label">Services given</span>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="fh5co-counter to-animate">
						<i class="fh5co-counter-icon icon-code to-animate-2"></i>
						<span class="fh5co-counter-number js-counter" data-from="0" data-to="200" data-speed="5000" data-refresh-interval="50">200</span>
						<span class="fh5co-counter-label">Reservations</span>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="fh5co-counter to-animate">
						<i class="fh5co-counter-icon icon-cup to-animate-2"></i>
						<span class="fh5co-counter-number js-counter" data-from="0" data-to="197" data-speed="5000" data-refresh-interval="50">197</span>
						<span class="fh5co-counter-label">People who had fun time</span>
					</div>
				</div>
				<div class="col-md-3 col-sm-6 col-xs-12">
					<div class="fh5co-counter to-animate">
						<i class="fh5co-counter-icon icon-people to-animate-2"></i>
						<span class="fh5co-counter-number js-counter" data-from="0" data-to="57" data-speed="5000" data-refresh-interval="50">57</span>
						<span class="fh5co-counter-label">Reservations Today</span>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="col-md-6 to-animate">
					...
					<ul class="fh5co-contact-info">
						<li class="fh5co-contact-address ">
							<i class="icon-home"></i>
							Opposite to Saravana Store, Thambaram, <br>Chennai
						</li>
						<li><i class="icon-phone"></i> (+91) 9790374010</li>
						<li><i class="icon-envelope"></i>arvindsrinivasan@damiler.com</li>
						<li><i class="icon-globe"></i> <a href="#" target="_blank">locationlogger.com</a></li>
					</ul>
				</div>
		...
		<div class="container">
			<div class="">
				<div class="col-md-12 text-center">
                    <p>&copy; Location Logger. All Rights Reserved. <br>Created by <a href="#" target="_blank">Syam Sundar K</a> </p>
