				...
				<!-- Header -->
					<header id="header">
						<div class="inner">
							...
							<!-- Logo -->
								<a href="#" class="logo">
									<span class="symbol"><img src="images/logo.svg" alt="" /></span><span class="title">Location Logger</span>
								</a>
				...
				<!-- Main -->
					<div id="main">
						<div class="inner">
                            ...
                            <p>You have successfully got your entry into the database.. Now Proceed to sign in..</p>
                            ...
                            <ul class="actions">
										<li><a href="http://localhost:8888/sign_in/index.php" class="button special">Sign in</a></li>
										<li><a href="http://localhost:8888/elate/index.php" class="button">Home page</a></li>
									</ul>
						</div>
					</div>
